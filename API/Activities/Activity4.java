...
public class Activity4 {
    ...
    public void addContact() {
        ...
        firstName.sendKeys("Anup K");
        lastName.sendKeys("Pal");
        phoneNumber.sendKeys("9158002090");

        // Save the contact
        driver.findElementById("editor_menu_save_button").click();

        // Wait for contact card to appear
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("toolbar_parent")));
        ...
        Assert.assertEquals(contactName, "Anup K Pal");
    }
